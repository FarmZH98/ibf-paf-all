package sg.edu.nus.iss.workshop25.config;
...
import sg.edu.nus.iss.workshop25.service.MessageProcessorService;
...
public class AppConfig {
    ...
    @Bean
    public RedisMessageListenerContainer createContainer() {
    // configure an instance of RedisConnectionFactory
        RedisConnectionFactory redisFac = createConnectionFactory();
        RedisMessageListenerContainer cont= new RedisMessageListenerContainer();
        cont.setConnectionFactory(redisFac);
        cont.addMessageListener(processorService, ChannelTopic.of("mytopic"));
        return cont;
    }
}
